      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <nav class="navbar navbar-expand-lg main-navbar">
              <form class="form-inline mr-auto">
                  ...
                  <h6 class="text-left text-white mt-3">Sistem Informasi Persediaan Produk</h6>
              </form>
          ...
          <div class="main-sidebar sidebar-style-2">
              <aside id="sidebar-wrapper">
                  <div class="sidebar-brand">
                      <a href="<?= base_url('dashboard') ?>"><b>SIPPRO</b></a>
                  </div>
                  <div class="sidebar-brand sidebar-brand-sm">
                      <a href="<?= base_url('dashboard') ?>">SIPPRO</a>
                  </div>
                      ...
                      <ul class="sidebar-menu">
                          ...
                          <li class="dropdown <?= $this->uri->segment('1') == 'kategori-produk' || $this->uri->segment('1') == 'data-produk' ? 'active' : '' ?>">
                              ...
                              <ul class="dropdown-menu">
                                  ...
                                  <li class="<?= $this->uri->segment('1') == 'data-produk' ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url("data-produk") ?>">Data Produk</a></li>
                              </ul>
                          </li>
                          ...
                          <li class="menu-header">Pemasok</li>
                          <li class="dropdown <?= $this->uri->segment('1') == 'pemasok' ? 'active' : '' ?>">
                              <a href="#" class="nav-link has-dropdown"><i class="fas fa-people-carry"></i> <span>Pemasok Produk</span></a>
                              <ul class="dropdown-menu">
                                  <li class="<?= $this->uri->segment('1') == 'pemasok' ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('pemasok'); ?>">Data Pemasok</a></li>
                              </ul>
                          </li>
                          ...
                          <li class="menu-header">SISARAN</li>
                      </ul>
