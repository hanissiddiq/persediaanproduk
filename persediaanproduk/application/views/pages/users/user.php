                                      ...
                                      <?php $n = 1;
                                        ...
                                        ?>
                                          <tr>
                                                                              ...
                                                                              <div class="col-lg-6">
                                                                                  ...
                                                                                  <div class="form-group">
                                                                                      ...
                                                                                      <select name="role_id" id="" class="form-control">
                                                                                          ...
                                                                                          <option value="1" <?= $us->role_id == '1' ? 'selected' : '' ?>>Admin</option>
                                                                                          <option value="2" <?= $us->role_id == '2' ? 'selected' : '' ?>>Pimpinan</option>
                                                                                          <option value="3" <?= $us->role_id == '3' ? 'selected' : '' ?>>Pemasok</option>
                                                                                          <option value="4" <?= $us->role_id == '4' ? 'selected' : '' ?>>Gudang</option>
                                                                                      </select>
                                                                                  </div>
                                                                                  <div class="form-group">
                                              ...
                                              <td>
                                                  <?= $us->role_id == '1' ? 'Admin' : '' ?>
                                                  <?= $us->role_id == '2' ? 'Pimpinan' : '' ?>
                                                  <?= $us->role_id == '3' ? 'Pemasok' : '' ?>
                                                  <?= $us->role_id == '4' ? 'Gudang' : '' ?>
                                              </td>
                                          </tr>
                                      <?php $n++;
