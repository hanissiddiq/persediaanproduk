          ...
          <section class="section">
              <div class="section-header">
                  ...
                  <div class="section-header-breadcrumb">
                      ...
                      <div class="breadcrumb-item"><a href="<?= base_url('produk-keluar') ?>">Produk Keluar</a></div>
                      <div class="breadcrumb-item">Data</div>
                  </div>
              </div>

              <div class="section-body">
                  <h2 class="section-title">Produk Keluar</h2>
              </div>
          </section>
          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="card">
                      ...
                      <div class="card-body">
                          <button class="btn btn-success btn-sm mb-2" data-toggle="modal" data-target="#tambahkeluar"><i class="fas fa-plus-circel"></i>Tambah Data</button>
                                      ...
                                      <?php $n = 1;
                                        foreach ($data_keluar as $keluar) { ?>
                                          <tr>
                                              <td><?= $n; ?></td>
                                              <td>
                                                  <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $keluar->id_produk_keluar ?>"><i class="fas fa-trash-alt"></i></button>
                                              </td>

                                              <!-- Modal Hapus -->
                                              <div class="modal fade" id="hapus<?= $keluar->id_produk_keluar ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      ...
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                              <div class="alert alert-warning text-center" role="alert">
                                                                  ...
                                                                  <b class="text-dark"><?= $keluar->nama_produk ?></b>

                                                              </div>
                                                          </div>
                                                          <div class="modal-footer">
                                                              <button type="button" class="btn btn-warning btn-sm" data-dismiss="modal">Close</button>
                                                              <a href="<?= base_url('hapus-produk-keluar/') . $keluar->id_produk_keluar ?>" type="button" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus Data</a>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
