          ...
          <section class="section">
              <div class="section-header">
                  ...
                  <div class="section-header-breadcrumb">
                      ...
                      <div class="breadcrumb-item"><a href="<?= base_url('pemasok') ?>">Pemasok</a></div>
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                              ...
                                                              <a href="<?= base_url('hapus-pemasok/') . $dataP->id_pemasok ?>" type="button" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus Data</a>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
                                                  ...
                                                  <div class="modal-dialog modal-lg">
                                                      <div class="modal-content">
                                                          <div class="modal-header bg-success">
                                                              <h5 class="modal-title text-white" id="exampleModalLabel">Tambah Data Pemasok</h5>
                                                          ...
                                                          <div class="modal-body">
                                                              <div class="row">
                                                                  <div class="col-lg-12">
                                                                      <form action="<?= base_url('edit-pemasok/') . $dataP->id_pemasok ?>" method="post" enctype="multipart/form-data">
                                                                          <div class="row">
                                                                              <div class="col-lg-6">
                                                                                  <div class="form-group">
                                                                                      <label for="up">Pilih User Pemasok</label>
